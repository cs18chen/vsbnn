This repository provides the code for the paper "Variational sparse Bayesian neural networks with regularized horseshoe priors and scale mixture priors".
