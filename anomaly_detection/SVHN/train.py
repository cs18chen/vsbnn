...
parser.add_argument('--model', type=str, default='MLP',
                    choices=['BNN, RegHP1, HS, MLP,Gauss,HP'], help='Choose architecture.')
...
# Checkpoints
parser.add_argument('--save', '-s', type=str, default='./checkpoints_800/', help='Folder to save checkpoints.')
...
train_data = dset.SVHN('./svhn', split='train',
