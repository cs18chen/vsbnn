...
from .network_layers import HorseshoeLayer, RegHorseshoeLayer,BayesianLinear
import math
import numpy as np
import torch
num_batches=550
...
class HorseshoeNet(nn.Module):
    ...
    def __init__(self, n_channels, n_classes):
        ...
        self.l1 = HorseshoeLayer(32*32*n_channels, 800)
    ...
    def sample_predict(self, x, Nsamples):
        ...
        predictions = x.data.new(Nsamples, x.shape[0], 100)#cifar10,10,  cifar100, 100
...
class BNN(nn.Module):
    def __init__(self, n_channels, n_classes):
        ...
        self.layer1 = BayesianLinear(32*32*n_channels, 800)
    ...
    def sample_predict(self, x, Nsamples):
        # Just copies type from x, initializes new vector
        predictions = x.data.new(Nsamples, x.shape[0], 10) #cifar10,10,  cifar100, 100
...
class HPBayesianNet(nn.Module):
    def __init__(self, n_channels, n_classes):
        ...
        self.layer1 = HorseshoeLayer(32*32*n_channels, 800)
    ...
    def analytic_update(self):
        ...
        analytic update equations
        """
        return self.layer1.analytic_update(), self.layer2.analytic_update(), self.layer3.analytic_update()
...
class RegHPBayesianNet1(nn.Module):
    def __init__(self, n_channels, n_classes):
        ...
        self.layer1 = RegHorseshoeLayer(32*32*n_channels, 800)
        #                                     (-1.5, 1.5, -5, -2, -1.5, 1.5, -5, -2) ) #(-1.27, 1.25, -1, -0.1, -1, 1, -2, -1) )
...
class MLP(nn.Module):
    def __init__(self,n_channels, n_classes):
        super().__init__()
        self.fc1 = nn.Linear(32*32*n_channels, 800)
